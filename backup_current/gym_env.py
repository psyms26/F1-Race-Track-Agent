...
class F1RaceEnv(gym.Env):
    ...
    def __init__(self, weather_scenario: str = None, seed: int = None):
        ...
        # Action space SCOPED to driving only: steering + throttle.
        # Pit/compound decisions are delegated to utility-style internal logic.
    ...
    def step(self, action):
        # RL controls only steering + throttle
        ...
        # Internal utility-style logic decides pit + compound
    ...
    # Mirrors rl_agent.py._strategy_decision EXACTLY — must stay in sync.
    ...
    def _compute_reward(self, prev_lap, prev_wear, prev_s,
        ...
        # PRIMARY: minimise race time. delta_time captures sim dt, pit time,
        # off-track penalty, and fuel-weight time effect — every cost in seconds.
